            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('bot.update') }}">
                        ...
                        <div class="mb-3">
                            <label for="allow_country" class="form-label">Allow Country</label>
                            <textarea class="form-control" id="allow_country" name="allow_country" rows="3" required>{{ $setting->allow_country }}</textarea>
                        </div>

                        <div class="mb-3">
                            <label for="allow_skill" class="form-label">Allow Skrill</label>
                            <textarea class="form-control" id="allow_skill" name="allow_skill" rows="3" required>{{ $setting->allow_skill }}</textarea>
                        </div>
